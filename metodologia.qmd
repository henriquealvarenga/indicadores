...
- **Ressalva explícita na legenda:** "valores aproximados transcritos de boletins (não usar como estatística oficial); 2024 preliminar".
...
**`tbn_pad`** — TBN bruta vs. padronizada por região (Figura *fig-tbn-padronizada*).

- **Natureza:** exemplo **ilustrativo** (valores fictícios) inspirado nos padrões reais descritos em IBGE/DATASUS e OPAS (2008) — *Indicadores Básicos para a Saúde no Brasil: Conceitos e Aplicações*, 2ª ed. Demonstra o **efeito** da padronização; não corresponde à estatística oficial de nenhum ano específico.
- **Ressalva explícita na legenda:** "exemplo ilustrativo ... valores fictícios, não são estatística oficial".
...
- **Ressalva explícita:** "valores ilustrativos: disparidade real, magnitudes aproximadas (não oficiais)".
