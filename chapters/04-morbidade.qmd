...
ggplot(dengue, aes(x = ano, y = incidencia)) +
  ...
  labs(
    ...
    caption = "Fonte: SINAN/SVS/MS — valores aproximados transcritos de boletins (não usar como estatística oficial); 2024 preliminar"
  ) +
  tema_indicadores() +
...
# Fonte: PNS 2019 (IBGE) e Vigitel 2023 (SVS/MS)
...
notif <- tibble::tribble(
  ...
  "Sarampo",            "Imediata (24h)",  "Brasil perdeu a certificação de eliminação (2019)",
