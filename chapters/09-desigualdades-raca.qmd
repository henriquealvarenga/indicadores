...
ggplot(rmm, aes(x = reorder(raca_cor, rmm), y = rmm,
  ...
  labs(
    ...
    caption = "Fonte: SVS/MS — DATASUS, SIM — valores ilustrativos: disparidade real, magnitudes aproximadas (não oficiais)"
  ) +
  tema_indicadores() +
...
ggplot(mi_raca, aes(x = reorder(raca_cor, mi), y = mi, fill = raca_cor)) +
  ...
  labs(
    ...
    caption = "Fonte: SVS/MS — DATASUS, SIM/SINASC — valores ilustrativos: disparidade real, magnitudes aproximadas (não oficiais)"
  ) +
  tema_indicadores() +
  theme(legend.position = "none")
```
...
# Fonte: Atlas da Violência 2023 (IPEA/FBSP), referentes a 2021
