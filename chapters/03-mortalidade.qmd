...
Caracteriza o risco médio de morte por qualquer causa. Contudo, a TBM **não controla a estrutura etária** — populações mais envelhecidas apresentam TBM mais elevada, mesmo com riscos etários idênticos (ver [capítulo sobre padronização](06-padronizacao.qmd)).
...
::: {.callout-note}
## Série projetada, não observada

A curva acima é a **projeção** demográfica do IBGE (Revisão 2018), não a mortalidade infantil **observada** pelo SIM/SINASC. A tendência de queda é real e bem documentada, mas os valores ano a ano são estimativas modeladas — para os dados observados, consulte o [TabNet/DATASUS](http://tabnet.datasus.gov.br/).
:::
...
::: {.callout-note}
Apesar de o nome histórico conter "*rate*", a CFR e a IFR são **proporções** (óbitos sobre casos), sem dimensão de pessoa-tempo — não são taxas no sentido epidemiológico estrito. O nome consagrado pelo uso foi mantido.
:::
